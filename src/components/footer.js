...
export default function Footer() {
  return (
    <footer className=" md:pt-14  pt-7 bg-primary-900 text-white md:pl-12 md:pr-12 pl-6 pr-6">
      <div>
        <div className="grid grid-cols-[1fr] md:grid-cols-[3fr_1fr_1fr] gap-7 border-b border-white">
          ...
          <label className="footer-list-wrapper mb-3 md:mb-5">
            ...
            <div className="footer-list text-[6px] md:text-[12px]">
              <div className="mb-2 md:mb-4">
                <a href="mailto:${sdhpkr@gmail.com}">
                  <div className="flex pr-5 md:pr-10">
                    <p>Email Us</p>
                  </div>
                </a>
                <a href="mailto:${sdhpkr@gmail.com}">
                  <p className="md:mt-2 mt-1">sdhpkr@gmail.com</p>
                </a>
              </div>
              <div className="mb-2 md:mb-4">
                <div className="flex pr-5 md:pr-10">
                ...
                <p className="md:mt-2 mt-1">03561244212</p>
              </div>
              <div className="mb-2 md:mb-4">
                <div className="flex pr-5 md:pr-10">
                  <p>Address</p>
                </div>
                <p className="md:mt-2 mt-1 max-w-[27ch]">
      ...
      <div className="flex justify-between w-full md:mt-5 md:mb-5 mt-3 mb-3">
        <a
          href="https://www.linkedin.com/in/debangan-banerjee/"
          className="socials-mine flex pt-2"
        >
          © Copyright 2024
        </a>
        <a
